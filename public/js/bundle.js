...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(2), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
const Marionette = __webpack_require__(5);
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<header class="fu-stock-header">\n  <h1>\n    Stock Watcher\n  </h1>\n  <form class="fu-stock-form">\n    <input type="text" name="symbol" id="symbol" value="GOOG" placeholder="Enter stock symbol..." class="fu-stock-symbol-field">\n    <button class="fu-stock-submit">Add</button>\n  </form>\n</header>\n<div class="fu-stock-display">\n  <ul class="fu-stocks"></ul>\n  <div class="fu-stock-none">\n    No stocks yet!\n  </div>\n</div>\n';
}
return __p;
};
